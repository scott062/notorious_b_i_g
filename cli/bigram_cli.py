...
# TODO: Migrate to rich dependency b/c this sucks, maybe another visualization file
def print_histogram(items, max_label=20):
    ...
    for (a, b), c in items: # Counter dict - c is counts
        ...
        if len(label) > label_width:
            label = label[:label_width - 3] + "..." # Truncating long labels for clarity TODO: Alt solution for expanding labels
